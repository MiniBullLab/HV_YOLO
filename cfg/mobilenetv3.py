...
from light.nn import _Hswish, _ConvBNHswish, Bottleneck, SEModule, globalAvgPool2d

__all__ = ['MobileNetV3', 'get_mobilenet_v3', 'mobilenet_v3_large_1_0', 'mobilenet_v3_small_1_0']

# width_mult width scale of the arch
# nl is the activation function
...
if __name__ == '__main__':
    ...
    # torch.onnx.export(model, x, "mobilenetv3.onnx", verbose=True)
