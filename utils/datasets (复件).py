...
class load_images_and_labels():  # for training
    def __init__(self, path, batch_size=1, img_size=[768, 320], multi_scale=False, augment=False):
        self.path = path
...
def test():
    ...
    dataloader = load_images_and_labels("/home/wfw/data/VOCdevkit/BerkeleyDet/ImageSets/Main/train.txt", batch_size=1, img_size=[640, 352], augment=True)
