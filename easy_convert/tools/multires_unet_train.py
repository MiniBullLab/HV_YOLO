...
from easy_convert.keras_models.seg.multires_unet import MultiResUnet
from easy_convert.keras_models.seg.multires_unet3d import MultiResUnet3D
...
def main():
    ...
    for img_fl in tqdm(img_files):
        if (img_fl.split('.')[-1] == 'jpg'):
            ...
            msk = cv2.imread('ISIC_2017_masks/ISIC-2017_Training_Part1_GroundTruth/{}'.format(
    ...
    model = MultiResUnet(input_size=(192, 256, 3))
