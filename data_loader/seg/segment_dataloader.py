...
from data_loader.seg.segment_sample import SegmentSample
from data_loader.seg.segment_dataset_process import SegmentDatasetProcess
from data_loader.seg.segment_data_augment import SegmentDataAugment
...
class SegmentDataLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        target = self.dataset_process.change_label(target)
