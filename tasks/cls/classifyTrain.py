...
from data_loader.cls.classify_dataloader import get_classify_train_dataloader
...
class ClassifyTrain():
    ...
    def train(self, train_path, val_path):
        dataloader = get_classify_train_dataloader(train_path, classifyConfig.imgSize,
                                                   classifyConfig.train_batch_size)
