...
import time
from data_loader.seg.segment_dataloader import get_segment_val_dataloader
...
class SegmentTest():
    ...
    def test(self, val_path):
        dataloader = get_segment_val_dataloader(val_path, segmentConfig.imgSize,
                                                segmentConfig.test_batch_size)
