...
rm -rf ./.log/segment*
python3 -m easyai.easy_ai --task SegNET --gpu 0 -i /home/minibull/lipeijie/dataset/CAR_segment/ImageSets/train.txt -v /home/minibull/lipeijie/dataset/CAR_segment/ImageSets/val.txt
